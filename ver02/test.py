...
def input_values():
    #return "input test"
    return render_template('test.html', title="input test", name="input_values")

@app.route('/tdg_input', methods=["post"])
def show_text():
   ...
   # num=print(len(input_value_list))+1###################################################
    ...
    #return "show test"
    return render_template('test.html', title="show test", name="show_name", result=result)
